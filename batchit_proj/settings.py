...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-some-default-secret-key-for-dev")
...
ROOT_URLCONF = 'batchit_proj.urls'
...
WSGI_APPLICATION = 'batchit_proj.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = 'batchit_app.Customer'
